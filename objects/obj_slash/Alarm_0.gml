...
if(slashing == true) {
	...
	if (instance_place(x, y, obj_knockbackProvider)) {
		...
		if savedSlashDirection == 0 {
			if obj_player.xSpeed > -2 && ((obj_player.xSpeed) * instance_place(x, y, obj_knockbackProvider).knockback) > instance_place(x, y, obj_knockbackProvider).knockback {
				obj_player.xSpeed = - ((obj_player.xSpeed) * instance_place(x, y, obj_knockbackProvider).knockback)
